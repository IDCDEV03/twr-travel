...
@section('title', 'แก้ไขแพ็คเกจทัวร์')
...
@section('content')
@foreach ($pk_tour as $item)
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">                      
                        <form class="needs-validation" action="{{url('/admin/update_package/'.$item->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf      
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="col-md-12 mb-2">
                                        <img id="preview-image-before-upload" src="{{asset($item->package_cover)}}"
                                            alt="preview image" style="max-height: 150px;">
                                            <input type="hidden" name="old_cover" value="{{$item->package_cover}}">
                                    </div>
                                    <div class="mb-3">
...
<hr>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="package_name" type="text" name="package_name" value="{{$item->package_name}}" required>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="package_location" value="{{$item->package_place}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="code_tour" type="text" value="{{$item->code_tour}}">
                                </div>

                                 <div class="col-md-6">
                                    <label class="form-label">ระยะเวลา</label>
                                    <input class="form-control" type="text" name="package_total_day" placeholder="เช่น 3 วัน 2 คืน" value="{{$item->package_total_day}}"
                                    >
                                </div>
                            </div>
<br>
<div class="row g-3"">
    <div class="col-md-6">
        <div class="mb-3">
           ...
           <input class="form-control digits" type="date"  name="package_period_start" value="{{$item->package_period_start}}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
           ...
           <input class="form-control digits" type="date"  name="package_period_end" value="{{$item->package_period_end}}">
        </div>
    </div>
</div>
<br>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{$item->package_veh}}" name="old_veh" readonly>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="package_min_cus" type="text" value="{{$item->package_min_customer}}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">ราคา (ต่อคน)</label>
                                    <input class="form-control" name="package_price" type="text" value="{{$item->package_price}}">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="old_file" value="{{$item->package_file}}">
                                </div>
                            </div>
<br>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="package_deposit" type="number" name="package_deposit" placeholder="ระบุเฉพาะตัวเลข ไม่ต้องใส่เครื่องหมาย %" maxlength="2" value="{{$item->package_deposit}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <input class="form-control" type="text" name="highlight_tour" value="{{$item->highlight_tour}}">
                              </div>
                              </div>
                              <br>
                            <div class="row">
                              ...
                              <textarea class="form-control" rows="8" name="package_detail" id="summernote">{{$item->package_detail}}</textarea>
                            </div>
                            </div>
