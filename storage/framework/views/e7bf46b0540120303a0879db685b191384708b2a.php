...
<html lang="en">
  <head>
    ...
    <meta name="description" content="ธัญวรัตม์ ทราเวล จองแพ็คเกจทัวร์ บริการรถบัสให้เช่า">
    <meta name="keywords" content="จองแพ็คเกจทัวร์ บริการรถบัสให้เช่า">
    <meta name="author" content="Thanwarat Travel">
    <link rel="icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" type="image/x-icon">
     <title>Thanwarat Travel - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Google font-->
...
</html><?php /**PATH C:\xampp\htdocs\twr_travel\resources\views/userLayouts/authentication/master.blade.php ENDPATH**/ ?>