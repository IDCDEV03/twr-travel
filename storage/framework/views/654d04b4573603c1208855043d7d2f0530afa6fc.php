                    ...
                    <div class="terms_service_content">
                        <div class="terms_item">
                            ...
                            <p class="h5">
                                ...
                                <p class="h5">
                                ที่อยู่ : 444/11 หมู่ 6 ซอยบ้านเดื่อ ตำบลหมากแข้ง อำเภอเมือง จังหวัดขอนแก่น 41000</p>
                                <p class="h5">
            ...
            <div class="row">      
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/cer1.jpg')); ?>" alt="img">
                     
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/a1.jpg')); ?>" alt="img">
                      
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/a2.jpg')); ?>" alt="img">
                      
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/a3.jpg')); ?>" alt="img">
...
</html><?php /**PATH C:\xampp\htdocs\twr_travel\resources\views/home/about-us.blade.php ENDPATH**/ ?>